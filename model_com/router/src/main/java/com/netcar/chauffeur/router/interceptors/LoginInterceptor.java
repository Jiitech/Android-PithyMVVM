package com.netcar.chauffeur.router.interceptors;

import android.content.Context;
import android.net.Uri;
import android.os.Bundle;

import com.jonyker.lib.pipe.PipeManager;
import com.lzh.compiler.parceler.Parceler;
import com.lzh.nonview.router.Router;
import com.lzh.nonview.router.extras.RouteBundleExtras;
import com.lzh.nonview.router.interceptors.RouteInterceptor;

import com.netcar.chauffeur.pipe.inter.LoginPipe;
import com.netcar.chauffeur.router.routings.Routing;
...
public class LoginInterceptor implements RouteInterceptor{
    ...
    public boolean intercept(Uri uri, RouteBundleExtras extras, Context context) {
        ...
        return !PipeManager.get(LoginPipe.class).isLogin();
    }
